...
class Metaclass_Calculator_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('calculator_interfaces')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_Calculator_Event(type):
    """Metaclass of message 'Calculator_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__calculator__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__calculator__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__calculator__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__calculator__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__calculator__event
...
class Calculator_Event(metaclass=Metaclass_Calculator_Event):
    """Message class 'Calculator_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<calculator_interfaces/Calculator_Request, 1>',
        'response': 'sequence<calculator_interfaces/Calculator_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['calculator_interfaces', 'srv'], 'Calculator_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['calculator_interfaces', 'srv'], 'Calculator_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from calculator_interfaces.srv import Calculator_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, Calculator_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'Calculator_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from calculator_interfaces.srv import Calculator_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, Calculator_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'Calculator_Response'"
...
class Metaclass_Calculator(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'calculator_interfaces.srv.Calculator')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from calculator_interfaces.srv import _calculator
            ...
            if _calculator.Metaclass_Calculator_Event._TYPE_SUPPORT is None:
                _calculator.Metaclass_Calculator_Event.__import_type_support__()


class Calculator(metaclass=Metaclass_Calculator):
    from calculator_interfaces.srv._calculator import Calculator_Request as Request
    from calculator_interfaces.srv._calculator import Calculator_Response as Response
    from calculator_interfaces.srv._calculator import Calculator_Event as Event
